...
| cash_generation_model | partial | Confirmed starting/current price and recent price movement; next-round price signal is now sanity-filtered against recent trend so stale external projections do not create absurd rises or crashes. Breakeven trend and peak-cash timing remain unavailable. |
